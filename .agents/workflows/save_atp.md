...
4. Update `ROADMAP.md` if an entire Epic was just finished via these Backlog items.
5. Update `README.md` if the changes affect usage or setup.
6. Create a git commit containing both the code and the documentation updates with a descriptive message.
