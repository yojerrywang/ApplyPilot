...
4. If you have created or updated the `task.md` or `walkthrough.md` artifacts during the session, ensure they accurately reflect the final state of the code.
5. Only after these documentation files are updated, stage them along with your code changes (`git add`).
6. Finally, commit the changes using `git commit`.
