...
5. Login wall?
  ...
  5c. Regular login form (employer's own site)? Try sign in with your email: {personal['email']}
  ...
  5e. Sign in failed? Try sign up with the same email and use a secure password manager/autofill when needed.
